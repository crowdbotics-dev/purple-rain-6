"""
Django settings for purple_rain_6 project.
...
ROOT_URLCONF = 'purple_rain_6.urls'
...
WSGI_APPLICATION = 'purple_rain_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "purple_rain_6 API",
    "DESCRIPTION": "API documentation for purple_rain_6 App",
    "VERSION": "v1",
}
